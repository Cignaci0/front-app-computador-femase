            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow key={item.id} className={cn("border-border", item.upgrade && !item.baja && "bg-emerald-500/10 hover:bg-emerald-500/20", item.baja && "bg-destructive/10 hover:bg-destructive/20")}>
